        ...
        <nav className="header-container">
            ...
            <ul className="menu-list">
                <li className="menu-list-item">
                    <a className={activeSection === 'home' ? 'active' : ''} href='#home'>{menuText[language].home}</a>
                </li>
                <li className="menu-list-item">
                    <a className={activeSection === 'features' ? 'active' : ''} href='#features'>{menuText[language].features}</a>
                </li>
            </ul>
